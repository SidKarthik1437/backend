...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', '192.168.248.207', '192.168.248.111', '0.0.0.0', 'nexa-server.azurewebsites.net', 'https://nexa-server.azurewebsites.net', '192.168.1.15', '192.168.0.101']
